...
export const BentoGridItem: React.FC<BentoGridItemProps> = ({
  ...
  return (
    <div
      className={cn(
        'row-span-1 rounded-xl font-geist-mono group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-[#efefef] border border-black justify-between flex flex-col space-y-4',
        className,
      )}
    >
      {header}
