...
export default function Journal({
  ...
  return (
    <section className="flex w-full flex-1">
      <div className="lg:w-4/6 space-y-4 overflow-y-scroll h-[calc(100vh-6rem)]  flex flex-col w-full">
      ...
      <div className="w-2/6 overflow-y-scroll h-[calc(100vh-6rem)] hidden lg:block">
